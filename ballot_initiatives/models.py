...
class Initiative(models.Model):
    ...
    fiscal_impact = models.CharField(max_length=2500,blank=True)
    proponent = models.CharField(max_length=200,blank=True)
    proponent_search = models.CharField(max_length=200,blank=True)
    ...
    sig_note = models.CharField(max_length=200,blank=True)

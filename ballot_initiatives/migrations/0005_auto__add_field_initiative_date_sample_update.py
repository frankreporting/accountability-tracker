...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Initiative.date_sample_update'
        db.add_column(u'ballot_initiatives_initiative', 'date_sample_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Initiative.date_sample_update'
        db.delete_column(u'ballot_initiatives_initiative', 'date_sample_update')
